...
# use curl
# bash <(curl -sL https://raw.githubusercontent.com/New-Tech-Consulting/NTC-Bitrix24-VM/main/install_full_environment.sh)

# use wget
# bash <(wget -qO- https://raw.githubusercontent.com/New-Tech-Consulting/NTC-Bitrix24-VM/main/install_full_environment.sh)
...
BRANCH="main"
SETUP_BITRIX_DEBIAN_URL="https://raw.githubusercontent.com/New-Tech-Consulting/NTC-Bitrix24-VM/$BRANCH/repositories/bitrix-gt/custom_from_install_full_environment_bitrix_setup_vanilla.sh"
...
git clone --branch=$BRANCH --depth 1 --filter=blob:none --sparse $REPO_URL "$DEST_DIR_MENU/NTC-Bitrix24-VM"
cd "$DEST_DIR_MENU/NTC-Bitrix24-VM"
...
rm -rf "$DEST_DIR_MENU/NTC-Bitrix24-VM"
