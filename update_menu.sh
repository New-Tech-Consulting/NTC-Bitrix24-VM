...
# use curl
# bash <(curl -sL https://raw.githubusercontent.com/New-Tech-Consulting/NTC-Bitrix24-VM/main/update_menu.sh)

# use wget
# bash <(wget -qO- https://raw.githubusercontent.com/New-Tech-Consulting/NTC-Bitrix24-VM/main/update_menu.sh)
...
git clone --depth 1 --filter=blob:none --sparse $REPO_URL "$DEST_DIR_MENU/NTC-Bitrix24-VM"
