...
BS_REPOSITORY_URL_FILE_VERSION="https://raw.githubusercontent.com/New-Tech-Consulting/NTC-Bitrix24-VM/${BS_BRANCH_UPDATE_MENU}/vm_menu/bash_scripts/config.sh"
BS_URL_SCRIPT_UPDATE_MENU="https://raw.githubusercontent.com/New-Tech-Consulting/NTC-Bitrix24-VM/${BS_BRANCH_UPDATE_MENU}/update_menu.sh"
