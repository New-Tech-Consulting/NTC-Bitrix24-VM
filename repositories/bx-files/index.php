...
if (LANG == 'ru')
{
	$msg = [
		...
		'setup_text' => "С помощью скрипта <a href=\"bitrixsetup.php\" target=\"_self\">BitrixSetup</a> загрузите дистрибутив пробной или коммерческой версии продукта непосредственно на ваш сервер.",
		'restore_text' => "Для восстановления копии проекта из бекапа скачайте и разместите в корне сайта скрипт <a href=\"restore.php\" target=\"_self\">Restore</a>.",
	];
}
elseif (LANG == 'de')
{
	$msg = [
		...
		'setup_text' => "Use <a href=\"bitrixsetup.php?lang=de\" target=\"_self\">BitrixSetup</a> script to upload the commercial or trial version of Bitrix24 directly to your web server.",
		'restore_text' => "Um eine Kopie des Projekts aus einem Backup wiederherzustellen, laden Sie die Datei <a href=\"restore.php?lang=de\" target=\"_self\">Restore</a> herunter und platzieren Sie sie im Stammverzeichnis der Site.",
	];
}
else
{
	$msg = [
		...
		'setup_text' => "Use <a href=\"bitrixsetup.php?lang=en\" target=\"_self\">BitrixSetup</a> script to upload the commercial or trial version of Bitrix24 directly to your web server.",
		'restore_text' => "To restore a copy of a project from a backup download and place <a href=\"restore.php?lang=en\" target=\"_self\">Restore</a> in the root of the site.",
	];
}
?>
<!DOCTYPE html>
