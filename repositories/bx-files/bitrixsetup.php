...
if (LANG == "ru")
{
	$MESS = [
		...
		"LOADER_DESCR" => "Этот скрипт предназначен для загрузки дистрибутивов \"1С-Битрикс\" с сайта <a href=\"https://git.newtech.consulting/ntc/ntc-products/bitrix-vm/debian12-bxvm/-/raw/main/index.php\" target=\"_blank\">www.1c-bitrix.ru</a> непосредственно на ваш сайт, а так же для распаковки дистрибутива на вашем сайте.<br><br> Загрузите этот скрипт в корневую папку вашего сайта и откройте его в браузере (введите в адресной строке браузера <nobr>http://&lt,ваш сайт&gt,/".$this_script_name."</nobr>).",
