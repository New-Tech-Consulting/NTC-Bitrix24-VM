...
list_sites(){
  ...
  # Function for filling an array with data
  fill_array() {
    local index=0
  ...
  # Function to output a horizontal line
  print_line() {
    printf "   +"
...
read_by_def(){
    ...
    local var_name=${2}  # name of the variable being set
    local def_val=${3}   # default value
    local user_input     # what the user entered
